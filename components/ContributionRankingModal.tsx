                    ...
                    {isLoading ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-gray-500 text-center p-4">
                            <div className="w-16 h-16 mb-4 flex items-center justify-center bg-red-500/10 rounded-full">
                                <RankIcon className="w-8 h-8 text-red-400" />
                            </div>
                            <p className="font-semibold text-red-400 mb-2">Erro ao carregar</p>
                    ...
                    <div className="flex flex-col items-center pt-2">
                        ...
                        {topUser ? (
                            <div className="flex flex-col items-center mb-6 relative mt-12">
                                ...
                                <h3 className="text-base font-bold text-white mt-1 mb-0.5 tracking-wide">{topUser.name || 'Usuário'}</h3>
                                
                                {/* Badges Row - Apenas LevelBadge no ranking ao vivo */}
                                <div className="flex items-center justify-center space-x-2 mb-1.5">
                                    {activeTab !== 'Live' && <GenderAgeBadge user={topUser} />}
                             ...
                             <div className="py-10 text-gray-500 font-medium text-center text-sm">
                                 <div className="w-16 h-16 mb-4 flex items-center justify-center bg-gray-500/10 rounded-full mx-auto">
                                     <RankIcon className="w-8 h-8 text-gray-400" />
                                 </div>
                                ...
                                >
                                    ...
                                    <div className="flex-grow min-w-0 flex flex-col justify-center">
                                        <div className="flex items-center space-x-2 mb-0.5">
                                            <p className="font-bold text-white truncate text-sm">{user.name || 'Usuário'}</p>
                                        </div>
                                        <div className="flex items-center space-x-1.5 scale-90 origin-left">
                                            {activeTab !== 'Live' && <GenderAgeBadge user={user} />}
