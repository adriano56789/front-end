                    ...
                    >
                        ...
                        <div className="space-y-2">
                            ...
                            <button
                                ...
                                className="w-full py-3.5 bg-zinc-800 hover:bg-zinc-700 active:scale-[0.98] text-zinc-300 font-medium text-sm rounded-full transition-all"
                            >
                                {t('common.cancel')}
                            </button>
                        </div>
