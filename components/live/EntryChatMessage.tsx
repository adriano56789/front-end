...
const EntryChatMessage: React.FC<EntryChatMessageProps> = ({ user, currentUser, onClick, onFollow, isFollowed, isBroadcaster, isModerator }) => {
    ...
    return (
        ...
        >
            <span 
                className="text-[#fbbf24] font-extrabold tracking-wide font-sans text-[8px]"
            ...
            {showFollowButton && (
                 <button
                    ...
                    className="ml-1 w-3.5 h-3.5 bg-[#a855f7] hover:bg-[#b055f7] text-white rounded-full flex items-center justify-center transition-all flex-shrink-0 cursor-pointer shadow-sm active:scale-95"
