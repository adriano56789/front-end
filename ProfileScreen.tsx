...
const ProfileScreen: React.FC<ProfileScreenProps> = ({ 
    ...
    // Debug logging para avatar
    console.log('🔍 ProfileScreen - currentUser data:', {
      id: currentUser?.id,
      name: currentUser?.name,
      avatarUrl: currentUser?.avatarUrl,
      isLive: currentUser?.isLive,
      streamStatus: currentUser?.streamStatus
    });
    
    const avatarAction = currentUser.isLive && currentUser.streamStatus === 'active' ? onOpenProfile : onOpenProfile;
    const avatarAriaLabel = currentUser.isLive && currentUser.streamStatus === 'active' ? "Ver perfil detalhado" : "Ver perfil detalhado";
        ...
        <div className="flex flex-col items-center pt-8 pb-4 px-4 bg-[#111111]">
          <button onClick={avatarAction} className="relative mb-4 group" aria-label={avatarAriaLabel}>
            <div className="relative w-24 h-24">
                ...
                {currentUser.isLive && currentUser.streamStatus === 'active' ? (
